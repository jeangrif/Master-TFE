...
def main(args):
    ...
    config = load_json(os.path.join('T-DEED/config', config_path))
    ...
    if (args.dataset == 'soccernet') | (args.dataset == 'soccernetball'):
        ...
        LABELS_SN_PATH = load_text(os.path.join('T-DEED/data', 'soccernet', 'labels_path.txt'))[0]
        LABELS_SNB_PATH = load_text(os.path.join('T-DEED/data', 'soccernetball', 'labels_path.txt'))[0]
    ...
    if args.pretrain != None:
        classes = load_classes(os.path.join('T-DEED/data', args.dataset, 'class.txt'))
        pretrain_classes = load_classes(os.path.join('T-DEED/data', args.pretrain['dataset'], 'class.txt'))
    ...
    for split in eval_splits:
        split_path = os.path.join(
            'T-DEED/data', args.dataset, '{}.json'.format(split))
